        ...
        <div class="card mb-4 wow fadeIn">
            ...
            <div class="card-body d-sm-flex justify-content-between">
                ...
                <h4 class="mb-2 mb-sm-0 pt-1">
                    <a href="https://mdbootstrap.com/material-design-for-bootstrap/" target="_blank">Welcome,</a>
                </h4>
...
<div class="container">
    <div class="row">
        <div class="offset-md-2 col-md-8">
            <h1><B><i>START FILLING ANNUAL RETURN</B></i></h1>
            <form validate="true">
                <div class="form-group">
                    <label for="Fullname">Fullname</label>
                    <input type="text" class="form-control" id="Fullname" aria-describedby="nameHelp" placeholder="Enter your Full Name" required>
                </div>
                <div class="form-group">
                    <label for="Address">Address</label>
                    <input type="text" class="form-control" id="Address" placeholder="Enter password" required>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="Establishment" placeholder="Establishment">
                    ...
                    <input type="text" class="form-control" id="Operation" placeholder="Name of operation/industry/work carried on">
                </div>
